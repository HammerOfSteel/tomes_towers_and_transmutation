 ...
 * cached and reused.
 */
export function normaliseTrackNames(clip) {
    ...
    cloned.tracks = cloned.tracks.map((track) => {
        ...
        const newTrack = Object.assign(Object.create(Object.getPrototypeOf(track)), track);
 ...
 */
export function prepareKayKitClips(clips) {
 ...
 */
export function countMatchingTracks(charScene, clips) {
