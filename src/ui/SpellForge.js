...
function _registerHybrid(sys, id, name, a, b) {
    sys._registerHybridSpell(id, name, a, b);
}
// ── Panel singleton ────────────────────────────────────────────────────────
let _panel = null;
let _closeKey = null;
export const SpellForge = {
    ...
    open(spellA, spellB, progression, spellSystem, onForged) {
        this.close();
        ...
        ingRow.append(mkChip(nameA, '#80c0ff'), Object.assign(document.createElement('span'), { textContent: '+', style: 'color:#7a5a8a;font-size:1.2rem;' }), mkChip(nameB, '#ff80a0'));
