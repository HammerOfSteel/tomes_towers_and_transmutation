...
export class QuestLog {
    ...
    getActive() { return this._quests.filter(q => !q.completed); }
    getAll() { return this._quests; }
    show() {
        this._visible = true;
        this._ensurePanel();
        this._render();
    ...
    _render() {
        ...
        const isStory = (q) => q.title.startsWith('[Story] ');
        ...
        const renderSection = (label, quests, isStorySection) => {
            if (quests.length === 0)
                return;
