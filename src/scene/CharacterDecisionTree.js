...
export class CharacterDecisionTree {
    async run(overlay) {
        ...
        await overlay.speak("Ah! You're awake. Excellent.\n" +
        ...
        if (species === 0) {
            ...
            if (humanChoice === 0) {
                ...
                await overlay.speak("A barbarian parent. That explains the immediate aggression.\n" +
                    "I'll reinforce the gate. Lovely chat.");
            }
            else if (humanChoice === 1) {
                characterId = 'human_paladin';
                await overlay.speak("A paladin. So preachy. So relentless.\n" +
                    "I receive unsolicited divine correspondence just from knowing one.\n" +
                    "It's exhausting.");
            }
            else if (humanChoice === 2) {
                characterId = 'rogue';
                await overlay.speak("A self-sufficient loner! How romantically tragic.\n" +
                ...
                await overlay.speak("A bard in the party. I'm going to be in a song.\n" +
            ...
            // ── UNDEAD ─────────────────────────────────────────────────────────────
            await overlay.speak("Undead! Oh, splendid. No feeding schedule, minimal upkeep.\n" +
            ...
            // ── VULPERIA ───────────────────────────────────────────────────────────
            await overlay.speak("A Vulperia! Magnificent. Mysterious, agile,\n" +
            ...
            if (foxChoice === 0) {
                ...
                await overlay.speak("The honest thief! A rare and admirable subtype.\n" +
                ...
                await overlay.speak("A fox ranger tracking through forests!\n" +
                    "How aggressively on-brand.\n" +
                    "Do you appreciate the irony, or has it become background noise?");
            }
            else if (foxChoice === 2) {
                characterId = 'fox_mage';
                await overlay.speak("A pyromancer fox. I'm choosing not to comment on that.\n" +
                    "Please stand away from the archives\n" +
                    "and try not to sneeze.");
            }
            else {
                characterId = 'fox_mysterious';
                await overlay.speak("Between career phases! That's just what rogues say between heists.\n" +
            ...
            if (slimeChoice === 0) {
                characterId = 'slime';
                await overlay.speak("Eloquent. Truly.\n" +
                ...
                await overlay.speak("You've absorbed my favourite quill. Sentimental value.\n" +
                ...
                await overlay.speak("An introvert slime! The rarest configuration.\n" +
                ...
                await overlay.speak("New! The early chapters! Everything is still possible.\n" +
