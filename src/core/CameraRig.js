...
export class CameraRig {
    camera;
    _aspect;
    _frustumHeight = FRUSTUM_HEIGHT;
    _targetFrustumHeight = FRUSTUM_HEIGHT;
    // ── Screen shake ──────────────────────────────────────────────────────────
    _shakeTimer = 0;
    _shakeDuration = 0;
    _shakeMag = 0;
    // ── Spell-cast zoom punch ─────────────────────────────────────────────────
    _punchOffset = 0; // current frustum offset (negative = zoom in)
    _punchTimer = 0;
    _punchDuration = 0;
    ...
    follow(target, dt = 0.016) {
        ...
        this.camera.position.set(target.x + ISO_OFFSET.x + ox, ISO_OFFSET.y, target.z + ISO_OFFSET.z + oz);
    }
    /**
