 ...
 */
export async function resolveBuilder(kind) {
    const entry = REGISTRY[kind];
    if (!entry)
        throw new Error(`[EntityRegistry] unknown kind: "${kind}"`);
    if (!entry.fn) {
