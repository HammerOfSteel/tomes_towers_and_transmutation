...
export function totalEnemyCount(def) {
 ...
 */
export function validateEncounterDef(def) {
    const errors = [];
    ...
    if (def.pattern === 'swarm' &&
        ...
        if (def.waveKillThreshold > perWave) {
            errors.push(`encounter "${def.id}": waveKillThreshold (${def.waveKillThreshold}) ` +
...
export const ENCOUNTER_POOL_F1 = [
    {
...
export const ENCOUNTER_POOL_F2 = [
    {
...
export const ENCOUNTER_POOL_F3 = [
    {
        id: 'f3_patrol_mixed',
        pattern: 'patrol',
        tier: 1,
...
export const ENCOUNTER_POOL_F4 = [
    {
        id: 'f4_elite_golem',
        pattern: 'elite',
        tier: 2,
...
export const ENCOUNTER_POOL_F5 = [
    {
...
export const ENCOUNTER_POOL_F6 = [
    {
        id: 'f6_elite_pig_man',
        pattern: 'elite',
        tier: 2,
...
export const ENCOUNTER_POOL_F7 = [
    {
...
export const ENCOUNTER_POOL_F8 = [
    {
...
export const ENCOUNTER_POOL_F9 = [
    {
