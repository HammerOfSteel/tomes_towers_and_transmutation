...
export function getGasGiantBandColor(latNorm, seed) {
...
export const PLANET_ATMOS_COLOR = {
    terran: [100, 160, 230],
    ocean: [60, 130, 220],
...
export const PLANET_MOON_COUNT = {
...
export function generatePlanetDNA(seed, type) {
