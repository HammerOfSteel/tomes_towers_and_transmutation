...
export const DEFAULT_PRINCESSES = [HUMAN, UNDEAD, FOXLING, SLIME];
 ...
 */
export function getDefaultPrincessForCharId(charId) {
...
export const PRINCESS_SPECIES_MAP = {
    // human-adjacent
