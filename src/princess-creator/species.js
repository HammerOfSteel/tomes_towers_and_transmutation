...
const pal = (id, label, colors) => ({ id, label, colors });
// Shared pool fragments
const CROWN_ROYAL = [['tiara', 4], ['classic', 3], ['flower', 2], ['none', 1], ['halo', 1]];
const NO_EXTRAS = {
    ears: [['none', 1]],
    tail: [['none', 9], ['thin', 1]],
};
const MOUTH_SWEET = [['smile', 5], ['open', 2], ['pout', 2], ['cat', 1]];
export const SPECIES_DEFS = {
    ...
    elf: {
        ...
        apply(d) {
            ...
            d.aura = { style: 'none', intensity: 0.5 };
            d.body.height = 1.08;
            d.body.headSize = 0.95;
            d.body.chubbiness = 0.85;
            d.body.armLength = 1.1;
            d.body.legLength = 1.1;
            d.hair = { style: 'long', length: 1.2 };
            d.parts.ears = 'long';
            d.parts.earSize = 1.0;
            d.parts.crown = 'tiara';
            d.parts.back = 'none';
            d.face.eyeStyle = 'sleepy';
            d.face.blush = 0.25;
            d.motion.idleStyle = 'sway';
            d.motion.energy = 0.4;
        },
    ...
    high_elf: {
        ...
        apply(d) {
            ...
            d.body.height = 1.2;
            d.body.headSize = 0.9;
            d.body.chubbiness = 0.75;
            d.body.armLength = 1.15;
            d.body.legLength = 1.15;
            d.body.shoulderWidth = 0.9;
            d.hair = { style: 'long', length: 1.5 };
            d.parts.ears = 'long';
            d.parts.earSize = 1.45;
            d.parts.crown = 'classic'; // an ACTUAL crown, hers by birthright
            d.parts.back = 'none';
            d.face.eyeStyle = 'lash';
            d.face.blush = 0.15;
            d.aura = { style: 'motes', intensity: 0.5 };
            d.motion.idleStyle = 'sway';
            d.motion.energy = 0.3;
            d.motion.bounce = 0.25;
        },
    ...
    pixie: {
        ...
        apply(d) {
            d.archetype = 'human';
            d.body.height = 0.55;
            d.body.headSize = 1.45;
            d.body.chubbiness = 1.05;
            d.body.armLength = 0.95;
            d.body.legLength = 0.85;
            d.hair = { style: 'wild', length: 0.8 };
            d.parts.ears = 'long';
            d.parts.earSize = 0.6;
            d.parts.back = 'wings_butterfly';
            d.parts.backSize = 1.25;
            d.parts.crown = 'flower';
            d.face.eyeStyle = 'sparkle';
            d.face.eyeSize = 1.2;
            d.face.blush = 0.6;
            d.aura = { style: 'none', intensity: 0.5 };
            d.motion.idleStyle = 'float';
            d.motion.energy = 0.85;
            d.motion.bounce = 0.8;
        },
    ...
    undead: {
        ...
        apply(d) {
            ...
            d.parts.crown = 'tiara';
            d.parts.crownTilt = 0.1;
            d.parts.back = 'none';
            d.face.eyeStyle = 'void';
            d.face.blush = 0;
            d.face.mouth = 'pout';
    ...
    celestial: {
        ...
        apply(d) {
            d.archetype = 'human';
            d.body.height = 1.15;
            d.body.chubbiness = 0.9;
            d.dress.puffSleeves = false; // the wings own that silhouette zone
            d.hair = { style: 'long', length: 1.2 };
            d.parts.ears = 'long';
            d.parts.earSize = 0.7; // pointed, less sharply than elves
            d.parts.crown = 'halo';
            d.parts.back = 'wings_feather';
            d.parts.backSize = 1.15;
            d.face.eyeStyle = 'star';
            d.face.blush = 0.3;
            d.aura = { style: 'warm', intensity: 0.7 };
            d.motion.idleStyle = 'float';
            d.motion.energy = 0.45;
        },
    ...
    draconic: {
        ...
        apply(d) {
            d.archetype = 'human';
            d.body.chubbiness = 1.15;
            d.body.shoulderWidth = 1.15;
            d.hair = { style: 'braided', length: 1.1 };
            d.parts.ears = 'horn_small';
            d.parts.earSize = 1.1;
            d.parts.crown = 'none'; // the horns ARE the crown
            d.parts.back = 'none';
            d.parts.tail = 'thin';
            d.parts.tailSize = 0.8; // small one, her choice
            d.face.eyeStyle = 'slit';
            d.face.blush = 0.2;
            d.face.mouth = 'fang';
            d.aura = { style: 'none', intensity: 0.5 };
            d.motion.idleStyle = 'sway';
    ...
    gnome: {
        ...
        apply(d) {
            d.archetype = 'human';
            d.body.height = 0.7;
            d.body.headSize = 1.35;
            d.body.chubbiness = 1.2;
            ...
            d.parts.handL = 'tome';
            d.face.eyeStyle = 'round';
            d.face.blush = 0.55;
            d.aura = { style: 'none', intensity: 0.5 };
            d.motion.idleStyle = 'bob';
            d.motion.energy = 0.7;
        },
    ...
    goblin: {
        ...
        apply(d) {
            ...
            d.parts.ears = 'long';
            d.parts.earSize = 1.6; // wide goblin radar
            d.parts.crown = 'crooked';
            d.parts.crownTilt = 0.2; // found it; hers now
            d.parts.back = 'none';
            d.face.eyeStyle = 'round';
            d.face.eyeSize = 1.25;
            d.face.mouth = 'fang';
    ...
    foxling: {
        ...
        apply(d) {
            d.archetype = 'fox';
            d.subtype = '1';
            d.body.chubbiness = 1.1;
            d.body.legLength = 0.95;
            d.body.hipWidth = 1.05;
            d.dress.style = 'hex';
            ...
            d.parts.earSize = 1.2;
            d.parts.tail = 'fluffy';
            d.parts.crown = 'classic';
            d.parts.back = 'none';
            d.face.eyeStyle = 'button';
            d.face.eyeTilt = 0.12;
            d.face.blush = 0.4;
            d.face.mouth = 'cat';
            d.aura = { style: 'none', intensity: 0.5 };
            d.motion.idleStyle = 'bob';
            d.motion.energy = 0.65;
            d.motion.bounce = 0.55;
        },
    ...
    ignis: {
        ...
        apply(d) {
            ...
            d.face.eyeStyle = 'glow';
            d.face.blush = 0.25;
            d.face.mouth = 'smile';
            d.dress.style = 'slim';
            d.dress.puffSleeves = false; // structured, not flowing
            d.dress.sash = true;
    ...
    moonborn: {
        ...
        apply(d) {
            ...
            d.parts.back = 'cape';
            d.parts.backSize = 1.1; // the cloak that pools
            d.face.eyeStyle = 'round';
            d.face.blush = 0.15;
            d.face.mouth = 'pout';
            d.dress.style = 'aline';
    ...
    orc: {
        ...
        apply(d) {
            d.archetype = 'human';
            d.body.height = 1.08;
            d.body.chubbiness = 1.35;
            d.body.shoulderWidth = 1.3;
            d.body.hipWidth = 1.2;
            d.hair = { style: 'braided', length: 1.1 };
            d.parts.crown = 'none';
            d.parts.back = 'cape';
    ...
    troll: {
        ...
        apply(d) {
            d.archetype = 'human';
            d.body.height = 1.32;
            d.body.chubbiness = 1.65;
            d.body.headSize = 0.92;
            d.body.armLength = 1.25;
            d.body.shoulderWidth = 1.25;
            d.body.hipWidth = 1.3;
    ...
    slime: {
        ...
        apply(d) {
            ...
            d.body.headSize = 1.1;
            d.body.chubbiness = 1.2;
            d.body.armLength = 0.9;
            d.body.legLength = 0.85;
            d.body.hipWidth = 1.15;
            d.dress.trim = false;
            d.dress.sash = false;
            d.dress.puffSleeves = false;
    ...
    skeleton: {
        ...
        apply(d) {
            ...
            d.body.chubbiness = 0.85;
            d.body.armLength = 1.05;
            d.body.legLength = 1.05;
            d.body.shoulderWidth = 0.95;
            d.body.hipWidth = 0.9;
            d.dress.style = 'aline';
            d.dress.puffSleeves = false;
            d.hair = { style: 'none', length: 1 };
            d.parts.crown = 'crooked';
            d.parts.crownTilt = -0.22;
            d.parts.back = 'cape';
            d.face.eyeStyle = 'glow';
            d.face.eyeSize = 1.05;
            d.face.blush = 0;
...
export function speciesDef(id) {
    return SPECIES_DEFS[id];
}
export const PALETTES = Object.fromEntries(Object.keys(SPECIES_DEFS).map((id) => [id, SPECIES_DEFS[id].palettes]));
export function defaultColors(species) {
    ...
    mage: {
        ...
        apply(d) {
            ...
            if (d.parts.handL === 'none' || d.parts.handL === 'tome')
                d.parts.handL = 'staff';
            if (d.parts.back === 'none')
                d.parts.back = 'grimoire';
        },
    },
    warrior: {
        ...
        apply(d) {
            ...
            d.dress.trim = false;
            d.parts.glasses = false;
            if (d.parts.back === 'none' || d.parts.back === 'bow')
                d.parts.back = 'cape';
        },
    },
};
