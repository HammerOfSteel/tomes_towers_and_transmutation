...
import { computeProportions, makeScaffold, addPuffSleeves, limbPart, shadowed, makeResult, } from './shared';
const SEGMENTS = 9;
export const lamiaSynth = {
    archetype: 'lamia',
    build(dna, kit) {
        ...
        const wrapGeo = new THREE.CylinderGeometry(p.topR * 1.18, p.topR * 1.42 * dna.dress.flare, 1.55, 24);
        ...
        const update = (t) => {
            ...
            for (let i = 0; i < chain.length; i++) {
                ...
                if (i >= 3)
                    node.rotation.x = basePitch + Math.sin(t * 1.9 + i) * 0.012;
            }
