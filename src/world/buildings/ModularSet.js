...
// ── Material factory ──────────────────────────────────────────────────────────
export function makeBuildingMat(hex, roughness = 0.85, condition = 'pristine') {
...
export function wallSegment(w, h, mat) {
...
export function windowPanel(colors) {
...
// ── Door ──────────────────────────────────────────────────────────────────────
export function doorPanel(colors) {
    const g = new THREE.Group();
 ...
 */
export function pitchedRoof(w, d, pitch = 0.55, mat) {
 ...
 */
export function hippedRoof(w, d, pitch = 0.50, hipFrac = 0.28, mat) {
    const hw = w / 2, hd = d / 2;
    const rh = w * pitch;
...
export function thatchedRoof(w, d, mat) {
    const g = new THREE.Group();
    ...
    for (let i = 0; i < numBands; i++) {
        ...
        for (const side of [-1, 1]) {
            const band = new THREE.Mesh(new THREE.BoxGeometry(0.16, 0.14, d * 0.97), // strip runs along Z
            bandMat);
