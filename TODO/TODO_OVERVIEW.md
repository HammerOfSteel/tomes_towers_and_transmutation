...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------- |
| G1  | **Game World Integration** — realm terrain/river/chunking (RI-1 to RI-4) and settlement spawning/roads/population/boundary/LOD (SI-1 to SI-6) data-transform/mesh/geometry slices all shipped as pure/tested modules; dungeon/cave wiring and actual `OverworldScene.ts` renderer integration (buildBuilding/buildNpc calls, physics colliders, audio zones, UI toasts, billboard/LOD render loop) still needed                                             | Blocking demo | `02-game-world-integration/`                               |
