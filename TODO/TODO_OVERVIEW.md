...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------- |
| G1  | **Game World Integration** — realm terrain/river/chunking (RI-1 to RI-4), settlement spawning/roads/population/boundary/LOD (SI-1 to SI-6), and dungeon entrance prop + site metadata (DI-1, DI-2, DI-2b) data-transform/mesh/geometry slices all shipped as pure/tested modules; cave wiring, dungeon scene transitions/minimap/quest hooks (DI-3 to DI-5), and actual `OverworldScene.ts` renderer integration still needed                                             | Blocking demo | `02-game-world-integration/`                               |
