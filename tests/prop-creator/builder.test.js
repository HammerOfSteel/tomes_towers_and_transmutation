...
import { MATERIAL_COLORS, KIND_SOLID } from '@/prop-creator/types';
import * as THREE from 'three';
const ALL_KINDS = [
    'chest', 'bookshelf', 'table', 'chair', 'cauldron', 'lantern',
    'pillar', 'rug', 'door', 'statue', 'barrel', 'crate',
];
const ALL_MATERIALS = ['stone', 'wood', 'bone', 'crystal', 'iron', 'clay'];
function makeDna(kind, material = 'wood', overrides = {}) {
    return {
