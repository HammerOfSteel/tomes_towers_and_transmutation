...
const shot = (page, name) => page.screenshot({ path: `tests/e2e/screenshots/viewer-${name}.png` });
async function loadViewer(page) {
    ...
    await page.waitForFunction(() => window.__assetViewerReady === true, { timeout: 90_000 });
