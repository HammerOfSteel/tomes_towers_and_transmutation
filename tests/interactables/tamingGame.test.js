...
function makeSlimeStub(personality) {
    const reactions = [];
    return {
        personality,
        tameReact(q) { reactions.push(q); },
        startTaming() { },
        stopTaming() { },
...
function clickButton(game, index) {
...
describe('TamingGame', () => {
    ...
    it('triggers onFail when score falls short', () => {
        ...
        const strip2 = strips2[strips2.length - 1];
        strip2.querySelectorAll('button')[1].click();
    ...
    it('calls tameReact on the slime once per round', () => {
        ...
        getStrip().querySelectorAll('button')[2].click();
        const reacts = slime._reactions;
        ...
        getStrip().querySelectorAll('button')[1].click();
        ...
        getStrip().querySelectorAll('button')[3].click();
