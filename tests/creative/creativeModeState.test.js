...
import { getCreativeState, isCreativeActive, setCreativeActive, setFlyEnabled, setNoClip, setGodMode, setFrozenEnemies, setCurrentZone, setCurrentSkin, setActiveTool, setActiveHotbarSlot, setHotbarSlot, cycleSpeedUp, cycleSpeedDown, getSpeedMultiplier, SPEED_MULTIPLIERS, } from '@/creative/CreativeModeState';
...
describe('CreativeModeState — speed tiers', () => {
    ...
    it('cycleSpeedUp advances through tiers', () => {
        ...
        const expectedIdx = SPEED_MULTIPLIERS.indexOf(before);
        if (expectedIdx !== -1) {
