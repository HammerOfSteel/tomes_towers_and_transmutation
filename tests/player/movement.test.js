...
import { calculateMoveDirection, ISO_FORWARD, ISO_BACKWARD, ISO_LEFT, ISO_RIGHT, } from '@/player/PlayerController';
// Helper — all movement vectors should be unit length (or zero)
const approxUnit = (v) => expect(v.length()).toBeCloseTo(1, 5);
const approxZero = (v) => expect(v.lengthSq()).toBeCloseTo(0, 5);
